    ...
    >
        <motion.div
            ...
            <div className="flex gap-4 ">
                <div className="w-[5px] bg-white rounded-full"></div>
                <p className="font-montserrat font-[800] text-[32px] text-white"><span className="text-primary">Commit Points</span> for Rewards</p>
            </div>
            ...
            <div className="flex items-center mt-[40px] justify-between">
                ...
                <p className=" font-montserrat font-[800] text-white text-[15px] bg-[#111111] px-[35px] py-[10px] shadow-lg rounded-full"><span className="text-primary">Min.</span> Participation points : <span className="text-[23px] text-primary">10</span></p>
            ...
            <div className="my-[25px] flex items-center justify-between gap-8">
                <div className="rounded-full  border-2 border-primary py-5 px-8 w-full" >
                    <input type="text" onChange={(e)=>setStakePrice(e.target.value)} className="text-white outline-none text-[30px] bg-transparent w-full font-bebasneue" placeholder="enter tokens to commit" />
                </div>
            ...
            <div className={`${stakePrice>0?"bg-primary ":" bg-[#666666]"} text-[#1B1C1E] rounded-full shadow-lg text-center w-[157px] mx-auto mt-[30px]`}>
                <p className={`round text-[35px] pt-2.5`}>commit</p>
            </div>
