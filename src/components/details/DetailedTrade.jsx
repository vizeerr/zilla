...
const DetailedTrade = () => {
  ...
  return (
    <div className='sm:my-0'> 
            <div className='flex  2xl:my-3 md:my-3 my-[3vw]  justify-between items-center md:px-2 px-[1vw]'>
              <p className='font-bebasneue 2xl:text-base lg:text-sm text-lg text-[4.2vw]'>BONDING CURVE PROGRESS</p>
              <p className='text-primary 2xl:text-base lg:text-sm text-lg text-[4.2vw] font-[700] font-montserrat'>{bondingPercentage}%</p>
            </div>
            ...
            <div className='bg-[#111111] shadow-[8.47px_9.52px_17.57px_0px_#00000040]  lg:mt-6 md:mt-6  mt-[5.3vw] 2xl:rounded-[1.3rem] md:rounded-[1rem] rounded-[6.3vw] lg:px-3 md:px-6 px-[4.8vw] 2xl:py-4 lg:py-4 md:py-6 py-[4.8vw]'>
              <p className='font-[700] 2xl:text-xs lg:text-[0.6rem] md:text-base text-[3.2vw] text-center leading-tight'>
            ...
            <div className='bg-[#2C2D30]  2xl:mt-5 lg:mt-3 md:mt-6 mt-[4vw] md:p-4 p-[3.5vw] shadow-[7.41px_7.41px_42.33px_0px_#00000040] 2xl:rounded-[1.2rem] md:rounded-[0.7rem] rounded-[4.5vw]'>
