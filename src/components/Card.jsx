...
const Card = ({data}) => {
  ...
  return (
    ...
    <div className="bg-white anim lg:rounded-[1.3rem] rounded-[4.8vw] py-[2.6vw] 2xl:px-2.5 lg:px-2 2xl:py-2 lg:py-1 px-[2.6vw] 2xl:w-[19rem] lg:w-[13rem] w-[90vw] shadow-[8.55px_9.98px_13.61px_0px_#00000040]">
        ...
        <div className="flex lg:flex-col flex-row lg:gap-0 gap-[1.6rem] mt-[2.1vw] lg:mt-0">
            ...
            <div className="2xl:h-48 lg:h-32  lg:w-full w-[33vw] h-[33vw] overflow-hidden lg:rounded-[1.2vw] rounded-[4.1vw] lg:mt-[0.6vw]">
            ...
            <div className="lg:w-full w-[48vw]">
                ...
                <div className="lg:mt-2.5 mt-[1vw]">
                    ...
                    <div className="bg-[#262626] mt-2 lg:py-0 py-[1.8vw] lg:rounded-[0px_0px_1rem_1rem] rounded-[2.4vw] 2xl:p-3 lg:p-1 shadow-[6px_6px_13.8px_0px_#000000C9]">
                        <p className="font-montserrat font-[900] text-primary text-center 2xl:text-[1rem] lg:text-xs 2xl:py-2 lg:py-1 text-[2.4vw]">MARKET CAP : 19.99K</p>
