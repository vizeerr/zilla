...
const Tabs = () => {
  ...
  return (
    <div className='bg-[#30313AE0] mt-4 flex lg:flex-row lg:gap-0  gap-[3vw] flex-col justify-between items-center lg:py-2.5 py-[2.1vw] lg:px-4 px-[3.3vw]'>
        ...
        <div className=" flex items-center 2xl:gap-4 lg:gap-3 gap-[2vw] relative">
            ...
            <div className="lg:w-auto 2xl:px-6 lg:px-4 w-[28vw] bg-[#1E1E25] shadow-[5px_4px_9.8px_0px_#00000040] rounded-full flex lg:gap-2.5  gap-[2.5vw] items-center justify-center lg:py-1.5 py-[1.5vw]">
              ...
              <div onClick={()=>setToogle(!toogle)} className={`${toogle? "bg-primary justify-end" : "bg-[#595959E8] justify-start" } tranis 2xl:w-12 lg:w-9 w-[6.4vw] flex items-center  rounded-full 2xl:h-4 lg:h-3 h-[2.1vw] `}>
