  ...
  return (
    <div className='sm:my-0'> 
            ...
            <div className='flex justify-between items-center mt-4 px-1'>
              <p className='font-bebasneue 2xl:text-[21px] lg:text-[18px] text-[4.2vw]'>BONDING CURVE PROGRESS</p>
              <p className='text-primary 2xl:text-[21px] lg:text-[18px] text-[4.2vw] font-[700] font-montserrat'>0.86%</p>
            </div>

            <div className='bg-[#111111] shadow-[8.47px_9.52px_17.57px_0px_#00000040]  mt-3  2xl:rounded-[32px] rounded-[28px] px-[15px] py-[30px]'>
              <p className='font-[700] 2xl:text-[16px] lg:text-[12px] text-[3.2vw] text-center leading-tight'>
              ...
              <p className='font-[700] 2xl:text-[16px] lg:text-[12px] text-[3.2vw] text-center mt-5 leading-tight'>
              ...
              <p className=' 2xl:text-[16px] lg:text-[12px] text-[3.2vw] text-center text-primary mt-5 font-[900]'>
            ...
            <div className='bg-[#2C2D30]  mt-6 p-4 shadow-[7.41px_7.41px_42.33px_0px_#00000040] rounded-[21px]'>
              <p className='uppercase font-bebasneue 2xl:text-[19px] lg:text-[15px] text-[4vw] font-[400]'>
              ...
              <p className='lg:text-[10px] 2xl:text-[13px] text-[13px] font-montserrat font-[900] text-center mt-4'>Dethrone <span className='font-[700] opacity-40'>the current king at </span> <span className='text-primary font-[900] font-montserrat'>$43,134 market cap.</span></p>
            </div>
