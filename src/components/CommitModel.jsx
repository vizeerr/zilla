...
const CommitModel = ({ open, setOpen }) => {
  ...
  return (
    <motion.div
      ...
      className={`${
        open ? "flex " : "hidden"
      } bg-[#00000080] fixed z-10  justify-center items-center w-full h-screen  px-[1.6vw] top-0`}
    ...
    >
      ...
      >
        <div className="flex gap-[1vw] ">
          ...
          <p className="font-montserrat font-[800] md:text-[1.6vw] text-[2.5vw] text-white">
            <span className="text-primary">Commit Points</span> for Rewards
          </p>
        </div>

        <div className="flex items-center md:mt-[2vw] mt-[3vw] justify-between">
          <p className=" font-montserrat font-[800] text-white md:text-[0.7vw] text-[1.7vw] bg-[#111111] px-[1.8vw] py-[0.5vw] shadow-lg rounded-full">
            <span className="text-primary">User</span> Balance :{" "}
            <span className="md:text-[1.1vw] text-[2vw] text-primary">123,456</span>
          </p>
          <p className=" font-montserrat font-[800] text-white md:text-[0.7vw] text-[1.7vw] bg-[#111111] px-[1.8vw] py-[0.5vw] shadow-lg rounded-full">
            <span className="text-primary">Min</span> Participation points :{" "}
            <span className="md:text-[1.1vw] text-[2vw] text-primary">10</span>
          </p>
        </div>
        ...
        <div className="md:my-[1.3vw] my-[3vw] flex items-center justify-between gap-[1.66vw]">
          <div className="rounded-full  md:border-2 border-[1px] border-primary md:py-[0.8vw] py-[1vw] flex items-center justify-center  md:px-[1.6vw] px-[2.5vw] w-full">
            <input
              type="text"
              onChange={(e) => setStakePrice(e.target.value)}
              className="text-white outline-none md:text-[1.5vw] text-[3.5vw] bg-transparent w-full font-bebasneue"
              placeholder="enter tokens to stake"
            />
          </div>
          <p className="font-montserrat font-[900] anim md:text-[1.6vw] text-[2.5vw] bg-primary shadow-[19.46px_32.43px_40.38px_0px_#00000040] rounded-[1.2vw] px-[2vw] py-[1vw]">
            MAX
          </p>
        </div>
        <div className="shadow-2xl bg-[#111111] md:p-[1vw] p-[1.9vw] rounded-[1vw]">
          ...
          <div className="flex justify-between items-center gap-[1vw] ">
            ...
            <p className="font-montserrat font-[800] md:text-[0.6vw] text-[1.5vw] text-white bg-[#363940] rounded-[0.5vw] px-[0.4vw] py-[0.3vw] shadow-md md:w-[2.6vw] w-[5vw]">
              {Math.round(value)}%
            </p>
          </div>
        </div>
        ...
        <div
          className={`${
            stakePrice > 0 ? "bg-primary " : " bg-[#666666]"
          } text-[#1B1C1E] rounded-full shadow-lg text-center md:w-[8.1vw] w-[14vw] mx-auto mt-[1.5vw]`}
        >
          <p
            className={`round md:text-[1.8vw] text-[4vw] pt-[0.5vw] md:leading-none leading-[4vw]`}
          >
            commit
          </p>
        </div>
