  ...
  return (
    <div className='bg-[#30313AE0] mt-[1vw] flex md:flex-row md:gap-0  gap-[3vw] flex-col justify-between items-center 2xl:py-3 md:py-2 py-[2.1vw] 2xl:px-5 lg:px-3 px-[3.3vw]'>
        <div className='flex 2xl:gap-3 lg:gap-2 md:gap-1.5 gap-[2.4vw]'>
          <button onClick={()=>selectTab(0)} className={`${selected==0? 'bg-primary  text-[#3F3F41]': 'bg-[#4C4C5A] text-white'} anim 2xl:px-5 lg:px-3 md:px-2 px-[2vw] font-[400]  rounded-full font-bebasneue  2xl:text-xl lg:text-xs md:text-[0.6rem] text-[2.5vw] 2xl:pt-1 lg:pt-1 md:pt-0.5 2xl:pb-0.5 lg:pb-0.5 mb:pb-1.5 pt-[0.5vw]`}>LAUNCHED TIME</button>
          <button onClick={()=>selectTab(1)} className= {`${selected==1?'bg-primary text-[#3F3F41]': 'bg-[#4C4C5A] text-white'}  anim 2xl:px-5 lg:px-3 md:px-2 px-[2vw] font-[400]  rounded-full font-bebasneue  2xl:text-xl lg:text-xs md:text-[0.6rem] text-[2.5vw] 2xl:pt-1 lg:pt-1 md:pt-0.5 2xl:pb-0.5 lg:pb-0.5 mb:pb-1.5 pt-[0.5vw]`}>TRADING VOLUME</button>
          <button onClick={()=>selectTab(2)} className={`${selected==2?'bg-primary text-[#3F3F41]': 'bg-[#4C4C5A] text-white'}  anim 2xl:px-5 lg:px-3 md:px-2 px-[2vw] font-[400]  rounded-full font-bebasneue  2xl:text-xl lg:text-xs md:text-[0.6rem] text-[2.5vw] 2xl:pt-1 lg:pt-1 md:pt-0.5 2xl:pb-0.5 lg:pb-0.5 mb:pb-1.5 pt-[0.5vw]`}>MARKET CAP</button>
          <button onClick={()=>selectTab(3)} className={`${selected==3?'bg-primary text-[#3F3F41]': 'bg-[#4C4C5A] text-white'}  anim 2xl:px-5 lg:px-3 md:px-2 px-[2vw] font-[400]  rounded-full font-bebasneue  2xl:text-xl lg:text-xs md:text-[0.6rem] text-[2.5vw] 2xl:pt-1 lg:pt-1 md:pt-0.5 2xl:pb-0.5 lg:pb-0.5 mb:pb-1.5 pt-[0.5vw]`}>24H PRICE INC.</button>
