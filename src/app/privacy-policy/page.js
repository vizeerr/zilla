  ...
  return (
    ...
    <div className="max-w-7xl mt-8 mx-auto p-6 font-montserrat text-white">
      ...
      <p className="mt-0 mb-3">
        ...
        <strong className="block text-base mt-4">Last Updated: 22 October 2024</strong>
      </p>

      <p className="mt-0 mb-3">
        This Privacy Notice (the “Notice”) describes the manner in which PumpZilla, together with its subsidiaries, affiliates, and related entities (collectively, “PumpZilla”, “we”, “us”, or “our”), collects, uses, discloses, and secures your personal data when you interact with our website, platform, and associated services. By visiting or using our Services, you agree to the terms of this Notice.
      </p>

      <div className='my-8'>

        <p className="mt-0 mb-4 text-2xl font-bold">1. Scope and Audience</p>

        <p className="mt-0 mb-3">
            <span className="font-bold">1.1 General Scope</span>
            <br />
        ...
        <p className="mt-0 mb-3">
            <span className="font-bold">1.2 Age Restrictions</span>
            <br />
        ...
        <p className="mt-0 mb-3">
            <span className="font-bold">1.3 Contractual Relationship</span>
            <br />
...
<p className="mt-0 mb-4 text-2xl font-bold">2. Role as Data Controller</p>

<p className="mt-0 mb-3">
  <span className="font-bold">2.1 Definition and Responsibilities</span>
  <br />
...
<p className="mt-0 mb-3">
  <span className="font-bold">2.2 Regulatory Requirements</span>
  <br />
...
<p className="mt-0 mb-4 text-2xl font-bold">3. Categories of Personal Data Collected</p>

<p className="mt-0 mb-3">
  <span className="font-bold">3.1 Financial and Blockchain-Related Data</span>
  <br />
...
<p className="mt-0 mb-3">
  <span className="font-bold">3.2 Account and Transaction Data</span>
  <br />
...
<p className="mt-0 mb-3">
  <span className="font-bold">3.3 Technical and Usage Information</span>
  <br />
...
<p className="mt-0 mb-3">
  <span className="font-bold">3.4 Compliance and Verification Data</span>
  <br />
...
<p className="mt-0 mb-3">
  <span className="font-bold">3.5 Data from Third Parties</span>
  <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">4. Legal Bases for Processing</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">4.1 Consent</span>
    <br />
    If you provide clear, unambiguous consent for specific processing activities (e.g., receiving marketing communications).
  </p>

  <p className="mt-0 mb-3">
    <span className="font-bold">4.2 Contractual Necessity</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">4.3 Legal Obligations</span>
    <br />
    We process data where necessary to comply with a statutory or regulatory requirement.
  </p>

  <p className="mt-0 mb-3">
    <span className="font-bold">4.4 Legitimate Interests</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">5. How We Use Your Personal Data</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">5.1 Providing and Improving Services</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">5.2 Transactions and Communications</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">5.3 Analytics and Performance Monitoring</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">5.4 Security and Fraud Prevention</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">5.5 Marketing and Communication (Where Permitted)</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">6. Cookies and Similar Technologies</p>

  <div className="mt-0 mb-3">
    <span className="font-bold">6.1 Types of Cookies Deployed</span>
    <br />
    <ul>
      <li><strong>Strictly Necessary:</strong> Enable essential features, such as page navigation and secure account access. Disabling these may compromise basic site functionality.</li>
      <li><strong>Functional:</strong> Help remember your settings and preferences, enabling a customized browsing experience.</li>
      <li><strong>Analytics/Performance:</strong> Gather data on usage patterns, allowing us to optimize the Services and troubleshoot problems.</li>
      <li><strong>Targeting:</strong> May be employed (subject to jurisdiction-specific requirements) to deliver content or notifications relevant to your interactions with our Services.</li>
    </ul>
  </div>

  <p className="mt-0 mb-3">
    <span className="font-bold">6.2 Cookie Management</span>
    <br />
    You can manage Cookies via your browser preferences, including blocking or deleting them. However, doing so may restrict certain functionalities on our platform. For additional guidance, consult your browser’s “Help” feature or visit <a href="https://www.allaboutcookies.org" className="text-blue-500">https://www.allaboutcookies.org</a>.
  </p>

  <p className="mt-0 mb-3">
    <span className="font-bold">6.3 Do Not Track Signals</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">6.4 Google Analytics</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">7. Sharing and Disclosure of Personal Data</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">7.1 Within PumpZilla and Affiliates</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">7.2 Third-Party Service Providers</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">7.3 Business Transactions</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">7.4 Legal and Regulatory Compliance</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">8. Data Retention and Deletion</p>

  <div className="mt-0 mb-3">
    <span className="font-bold">8.1 Retention Criteria</span>
    <br />
    PumpZilla retains personal data for as long as it is required to fulfill the objectives for which it was originally gathered. Factors influencing the retention duration include:
    <ul>
      <li>Regulatory Mandates: Certain laws prescribe minimum data-retention periods.</li>
      <li>Contractual Obligations: Data may be retained to fulfill obligations under user agreements or other contracts.</li>
      <li>Business Needs: We may store data for operational, audit, or security purposes, provided retention does not conflict with legal or privacy obligations.</li>
    </ul>
  </div>

  <p className="mt-0 mb-3">
    <span className="font-bold">8.2 Deletion and Anonymization</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">8.3 Blockchain Considerations</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">9. Data Security Measures</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">9.1 Security Protocols</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">9.2 User Responsibilities</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">9.3 No Absolute Guarantee</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">10. International Data Transfers</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">10.1 Global Operations</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">10.2 Adequate Safeguards</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">10.3 User Acknowledgment</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">11. Your Rights and Choices</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">11.1 Access, Correction, and Erasure</span>
    <br />
    • <span className="font-bold">Right to Access:</span> Subject to legal constraints, you have the right to request information about the personal data we hold about you and to obtain a copy in a structured, commonly used, and machine-readable format.<br />
    • <span className="font-bold">Right to Rectification:</span> You may request corrections to inaccurate or incomplete data.<br />
    • <span className="font-bold">Right to Erasure:</span> Under certain circumstances, you can ask that we delete your personal data, barring retention obligations (e.g., legal compliance).
  </p>

  <p className="mt-0 mb-3">
    <span className="font-bold">11.2 Restriction and Objection</span>
    <br />
    • <span className="font-bold">Restriction:</span> You may request a limitation on how we use your data if, for instance, you dispute its accuracy or object to our processing.<br />
    • <span className="font-bold">Objection:</span> You can object to processing conducted on the basis of legitimate interests, including profiling. We will review your request unless there are compelling grounds that override your interests or rights.
  </p>

  <p className="mt-0 mb-3">
    <span className="font-bold">11.3 Data Portability</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">11.4 Withdrawal of Consent</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">11.5 Exercise of Rights</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">12. Additional Notices for Certain Jurisdictions</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">12.1 California Residents</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">12.2 EEA and UK Residents</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">12.3 Other Territories</span>
    <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">13. Third-Party Websites and Services</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">13.1 External Links</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">13.2 Social Media and External Platforms</span>
    <br />
...
<div className='my-8'>
<p className="mt-0 mb-4 text-2xl font-bold">14. Automated Decision-Making and Profiling</p>

<p className="mt-0 mb-3">
  <span className="font-bold">14.1 Overview</span>
  <br />
...
<p className="mt-0 mb-3">
  <span className="font-bold">14.2 Your Rights</span>
  <br />
...
<div className='my-8'>
  ...
  <p className="mt-0 mb-4 text-2xl font-bold">15. How to Contact Us</p>

  <p className="mt-0 mb-3">
    <span className="font-bold">15.1 Primary Contact Method</span>
    <br />
  ...
  <p className="mt-0 mb-3">
    <span className="font-bold">15.2 Data Protection Officer (DPO)</span>
    <br />
  ...
  <div className='my-8'>
  <p className="mt-0 mb-4 text-2xl font-bold">16. Changes to This Privacy Notice</p>
