    ...
    <div className="bg-white anim md:rounded-[1.3rem] rounded-[4.8vw] py-[2.4vw] 2xl:px-2.5 md:px-2 2xl:py-2 md:py-1 px-[2.5vw] 2xl:w-[19rem] md:w-[15rem] w-[92vw] shadow-[8.55px_9.98px_13.61px_0px_#00000040]">
        <div className="flex items-center justify-between">
            ...
            <div className="flex 2xl:gap-2 md:gap-1 gap-[1vw] items-start">
                ...
                <div className="bg-[#262626] anim 2xl:w-6 md:w-5  w-[3.5vw] 2xl:h-6 md:h-5 h-[3.5vw] flex justify-center items-center rounded-full 2xl:p-1.5 md:p-1 p-[4px]">
                    <Image src={wlogo}  className="" alt="" unoptimized={true}/>
                </div>
                </Link>
                <Link href={data.twitter}>
                <div className="bg-[#262626] anim 2xl:w-6 md:w-5  w-[3.5vw] 2xl:h-6 md:h-5 h-[3.5vw] flex justify-center items-center rounded-full 2xl:p-1.5 md:p-1.5 p-[5px]">
                    <Image src={xlogo}  className="" alt="" unoptimized={true}/>
                </div>
                </Link>
                <Link href={data.telegram}>
                <div className="bg-[#262626] anim 2xl:w-[1.55rem] md:w-5  w-[3.5vw] 2xl:h-6 md:h-5 h-[3.5vw] flex justify-center items-center rounded-full 2xl:p-1.5 md:p-1.5 p-[5px]">
