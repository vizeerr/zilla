...
const Card = ({data}) => {
  ...
  return (
    ...
    <div className="bg-white anim md:rounded-[1.3rem] rounded-[4.8vw] py-[2.6vw] 2xl:px-2.5 md:px-2 2xl:py-2 md:py-1 px-[2.6vw] 2xl:w-[19rem] md:w-[15rem] w-[90vw] shadow-[8.55px_9.98px_13.61px_0px_#00000040]">
        ...
        <div className="flex md:flex-col flex-row md:gap-0 gap-[1.6rem] mt-[2.1vw] md:mt-0">
            ...
            <div className="2xl:h-48 md:h-36  md:w-full w-[33vw] h-[33vw] overflow-hidden md:rounded-[1.2vw] rounded-[4.1vw] md:mt-[0.6vw]">
            ...
            <div className="md:w-full w-[48vw]">
                <div className="md:mt-2.5 mt-[0.6vw]">
                    <p className="font-bebasneue 2xl:text-base md:text-sm text-[3.8vw] font-[400] text-[#262626]">{data.name} <span className=" font-[800] font-montserrat ">(${data.symbol})</span></p>
                    <p className="font-montserrat text-[#262626B5] font-[700] 2xl:text-[0.6rem] md:text-[0.45rem] text-[2.2vw]">Created by {shortId(data.creator)}</p>
                </div>
                <div className="md:mt-2.5 mt-[1vw]">
                    <div className="bg-[#D9D9D9] md:rounded-[1vw_1vw_0px_0px] rounded-[2.4vw] 2xl:p-2.5 md:p-1.5 p-[2vw]">
                        <p className="text-[#262626C2] font-montserrat font-[800] 2xl:text-[0.52rem] md:text-[0.4rem] text-[1.7vw] leading-tight 2xl:h-[3.2rem] md:h-10 h-[13vw] overflow-hidden">{data.description.slice(0,270)}...</p>

                    </div>
                    <div className="bg-[#262626] mt-2 md:py-0 py-[1.8vw] md:rounded-[0px_0px_1rem_1rem] rounded-[2.4vw] 2xl:p-3 md:p-2 shadow-[6px_6px_13.8px_0px_#000000C9]">
