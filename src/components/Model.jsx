        ...
        >
            ...
            >
                <Image
                    ...
                    alt=""
                />
                <h1 className="round ms-12 font-[500] text-center text-[64.23px] text-white">
                    Pump, <span className="text-primary">Profit</span>, Repeat!
                </h1>
                <p className="text-white font-montserrat text-[17.53px] font-[700] leading-[20.81px] w-[72%] mx-auto text-center">
                ...
                <Image src={modelmg} className="mt-8" alt="" />
