...
const HeaderProfile = () => {
  return (
    <div className="2xl:w-[24rem] md:w-[18rem] w-[72.5vw] md:rounded-[1.3rem] rounded-[4.4vw] relative bg-[#2E2F37] shadow-[7.41px_8.65px_11.79px_0px_#00000040] mx-auto  ">
            ...
            <div>
                <div className="flex items-center gap-[0.4vw] 2xl:px-2.5 md:px-1.5 px-[2vw] 2xl:pt-2.5 md:pt-1 pt-[1.5vw]">
                    <div className="md:py-1 py-[0.6vw] md:px-1.5 px-[0.9vw] flex md:gap-1 gap-[0.5vw] items-center bg-[#1B1B21] rounded-full">
                        <div className='md:w-3.5 w-[2.2vw]'>
                            <Image src={clock} className='w-full'/>
                        </div>
                        <p className="font-montserrat font-[800] 2xl:text-[0.5rem] md:text-[0.45rem] text-[1.4vw] text-white">1 hr 25 mins ago</p>
                    </div>
                ...
                <div className="md:mt-2.5 mt-[1.8vw] flex items-center md:gap-3.5 gap-[3vw] 2xl:px-4 md:px-2 px-[3.3vw]">
                    <div className="2xl:w-24 md:w-20 w-[18vw] 2xl:h-24 md:h-20 h-[18vw] md:rounded-[0.6rem] rounded-[2.1vw] overflow-hidden">
                        <Image src={pifico} className="w-full"/>
                    </div>
                    <div>
                        <p className="font-bebasneue font-[400] 2xl:text-base md:text-sm text-[3.1vw] text-white leading-none">CAT SWAP PROMOTION <span className="text-primary font-montserrat font-[800] 2xl:text-[0.9rem] md:text-[0.6rem] text-[2.9vw]">(PROMOTION)</span></p>
                        ...
                        <div className="bg-[#1B1B21] shadow-[5.2px_5.2px_11.96px_0px_#000000C9] md:py-2 py-[0.8vw] w-full text-center md:rounded-[0.6rem] rounded-[2vw] md:mt-2.5 mt-[1.4vw]">
                            <p className="text-primary 2xl:text-xs md:text-[0.6rem] text-[2.4vw] font-[800] ">MARKET CAP : 19.99K</p>
                        </div>
                    </div>
            ...
            <div className="bg-primary py-[0.15vw] text-center md:mt-2.5 mt-[2vw] md:rounded-b-[1.3rem] rounded-b-[4.4vw]">
                <p className="font-montserrat font-[900] 2xl:text-base md:text-sm text-[3.1vw] text-[#262626]">KING OF THE MONSTERS</p>
            </div>
        </div>
  )
}
