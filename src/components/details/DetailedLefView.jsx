    ...
    <div className='flex flex-col lg:gap-[1.6vw] md:gap-6 gap-[3.1vw] w-full'>
          ...
          <div className='bg-[#1B1C1E] 2xl:p-5 md:p-3 p-[1.6vw] flex flex-col justify-between shadow-[12.7px_12.7px_44.02px_0px_#0000004F] 2xl:rounded-[2rem] md:rounded-[1.5rem] rounded-[2.7vw]'>
              ...
              <div className='flex items-center md:gap-6 gap-[2.1vw]'>
                <div className=' bg-[#0A0A0B] 2xl:rounded-[1.2rem] xl:rounded-[0.8rem] md:rounded-[0.5rem] rounded-[2vw] relative overflow-hidden 2xl:w-52  md:w-36 2xl:h-56  md:h-36 w-[20.8vw] h-[20.3vw]'>
              ...
              />
                ...
                <div className=' w-full'>
                  <div className='flex justify-between items-center'>
                    ...
                    <p className='font-[500] bg-[#363940] 2xl:py-1.5 md:py-1 px-2 2xl:rounded-lg md:rounded-md shadow-lg tracking-wide 2xl:text-xs md:text-[0.45rem] text-[1.6vw] mb-[0.2vw] text-primary'><span className='text-[#FFFFFF4D]'>Created by</span> {shortId(tokenData.creator)}</p>
                  </div>
                    ...
                    <div className='flex justify-evenly  2xl:mt-5 md:mt-3 mt-[2.5vw] 2xl:gap-5 md:gap-3 gap-[1.3vw] md:pe-0 pe-[1.6vw] '>
                      ...
                      <div className='bg-primary w-full 2xl:rounded-xl md:rounded-[0.5rem] rounded-[1.9vw] 2xl:px-4 md:px-2.5 2xl:py-2 md:py-2 p-[1.4vw] shadow-[7.41px_7.41px_26.45px_0px_#00000040]'>
                        <p className='capitalize text-[#1B1C1E] font-bebasneue font-[400] 2xl:text-lg md:text-xs text-[3vw]'>Market Cap</p>
                        <p className='text-[#1B1C1E] font-[800] 2xl:text-sm md:text-[0.55rem] text-[2vw]'>$99,999</p>
                      </div>

                      <div className='bg-[#363A40] w-full 2xl:rounded-xl md:rounded-[0.5rem] rounded-[1.9vw] 2xl:px-4 md:px-2.5 2xl:py-2 md:py-2 p-[1.4vw] shadow-[7.41px_7.41px_26.45px_0px_#00000040]'>
                      ...
                      <div className='bg-[#363A40] w-full 2xl:rounded-xl md:rounded-[0.5rem] rounded-[1.9vw] 2xl:px-4 md:px-2.5 2xl:py-2 md:py-2 p-[1.4vw] shadow-[7.41px_7.41px_26.45px_0px_#00000040]'>
                        <div className='flex justify-end float-end'>
                          <div className='2xl:w-5 md:w-3'>
                            <Image src={primcopy} alt=''/>
                          </div>
                        </div>
                        <div className='flex 2xl:gap-2 md:gap-1 items-center'>
                          <p className='capitalize font-bebasneue font-[400] 2xl:text-lg md:text-xs text-[3vw]'>CONTRACT</p>
                          <div className='2xl:w-4 w-3' onClick={handleContCopy}>
                            <Image src={copyWhite} alt=''/>
                          </div>
                        </div>
                        <p className='text-primary font-[800] 2xl:text-sm md:text-[0.55rem] text-[2vw]'>{contCopiedText}</p>
                      </div>
          ...
          <div className='bg-[#1B1C1E] shadow-[12.7px_12.7px_44.02px_0px_#0000004F] 2xl:p-5 md:p-4 2xl:rounded-[2rem] md:rounded-[1.4rem] rounded-[2.9vw] overflow-hidden'>
